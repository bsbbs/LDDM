function [rt, choice, argmaxR, dR] = LcDsInhbt_dff_RndInput_Gaba_2mtrx_GPU(Vinput, Gaba, w, a, b, sgm, sgmInput, Tau, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule, sims)
%%%%%%%%%%%%%%%%%%
