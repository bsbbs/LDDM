function [R, G, I, Vcourse, rt, choice] = AsymW_RndInput_GABAblock(Vinput, Gaba, w, a, b, sgm, sgmInput, Tau, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule)
%%%%%%%%%%%%%%%%%%
