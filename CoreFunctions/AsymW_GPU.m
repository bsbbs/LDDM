function [rt, choice, argmaxR] = AsymW_GPU(Vinput, w, a, sgm, Tau, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule, sims)
%%%%%%%%%%%%%%%%%%
...
%% 1st stage, presenting and decision, V turned on, working memory (alpha) up
