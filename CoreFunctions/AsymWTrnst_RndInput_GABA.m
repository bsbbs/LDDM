function [R, G, I, Vcourse, rt, choice] = AsymWTrnst_RndInput_GABA(Vinput, Gaba, wraw, a, sgm, sgmInput, Tau, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule)
%%%%%%%%%%%%%%%%%%
