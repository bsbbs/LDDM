function [rt, choice, argmaxR] = LcDsInhbt_NMDA_GPU(Vinput, NMDA, w, a, b, sgm, Tau, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule, sims)
%%%%%%%%%%%%%%%%%%
...
for ti = 1:(onset_of_stimuli-1)
    % update R, G, I
    G1 = G1 + (-G1 + NMDA*w11*R1 + NMDA*w12*R2 - I1)/Tau2*dtArray + InoiseG1;
