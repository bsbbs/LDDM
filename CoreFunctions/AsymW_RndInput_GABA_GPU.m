function [rt, choice, argmaxR, dR] = AsymW_RndInput_GABA_GPU(Vinput, Gaba, w, a, sgm, sgmInput, Tau, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule, sims)
%%%%%%%%%%%%%%%%%%
