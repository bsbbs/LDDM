...
addpath(fullfile(Homedir,'Documents','LDDM','Froemke/SlfExt_Input/'));
cd('G:\My Drive\LDDM\Froemke\SlfExt_Input');
...
if ~exist(output,'file')
        ...
        [rt, choice, ~] = LDDM_SlfExt_GPU(Vprior, Vinput, iSTDP, w, a, b,...
