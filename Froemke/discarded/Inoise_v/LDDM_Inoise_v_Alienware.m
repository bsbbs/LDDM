...
addpath(fullfile(Homedir,'Documents','LDDM','Froemke/Inoise_v'));
cd('G:\My Drive\LDDM\Froemke\Inoise_v');
...
for level = 1:length(boost)
    ...
    [choice, rt, R, G, I, Vcourse] = LDDM_v_RndInput(Vprior, Vinput, iSTDP, w, a, b,...
...
if ~exist(output,'file')
        ...
        [rt, choice, ~] = LDDM_v_Rndinput_GPU(Vprior, Vinput, iSTDP, w, a, b,...
