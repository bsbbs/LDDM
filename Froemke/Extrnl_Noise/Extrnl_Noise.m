...
% plot(x, I(:,1), 'r-.', 'LineWidth', lwd);
% plot(x, I(:,2), 'b-.', 'LineWidth', lwd);
yticks([10, 15, 20, 25]);
...
h3.FaceColor = myred(3,:);
h3.EdgeColor = 'n';
h4 = histogram(R(2000:end,2),100);
h4.FaceColor = myblue(3,:);
h4.EdgeColor = 'n';
