...
addpath(fullfile(Homedir,'Documents','LDDM','Froemke/SST_Inoise_av'));
cd('G:\My Drive\LDDM\Froemke\SST_Inoise_av');
...
for level = 1:length(boost)
    ...
    [choice, rt, R, G, I, Vcourse] = LDDM_STDP_av_RndInput(Vprior, Vinput, iSTDP, w, a, b,...
...
if ~exist(output,'file')
        ...
        [rt, choice, ~] = LDDM_STDP_av_Rndinput_GPU(Vprior, Vinput, iSTDP, w, a, b,...
