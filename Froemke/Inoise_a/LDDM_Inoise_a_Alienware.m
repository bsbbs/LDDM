...
addpath(fullfile(Homedir,'Documents','LDDM','Froemke/Inoise_a'));
cd('G:\My Drive\LDDM\Froemke\Inoise_a');
...
for level = 1:length(boost)
    ...
    [choice, rt, R, G, I, Vcourse] = LDDM_a_RndInput(Vprior, Vinput, iSTDP, w, a, b,...
...
if dur >= 45
    ...
    savefigs(h, filename, plotdir,fontsize-5, [4,5]);
end
...
if ~exist(output,'file')
        ...
        [rt, choice, ~] = LDDM_a_Rndinput_GPU(Vprior, Vinput, iSTDP, w, a, b,...
