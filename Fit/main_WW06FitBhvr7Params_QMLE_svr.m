...
% likelihood function
% parpool(6);
nLLfun = @(params) WW06FitBhvr7Params_QMLE_GPU(params, dataDynmc, dataBhvr);
[fvalbest,~,~] = nLLfun(x0)
...
addpath('../../CoreFunctions/');
addpath('./SvrCode/');
out_dir = './Rslts/WW06FitBhvr5Params_QMLE_GPU';
if ~exist(out_dir,'dir')
    mkdir(out_dir);
end
...
randseed = 51721269;
rng(randseed);
%    JNp, JNn, I0, noise, miu0
params = [0.092641	0.197125	0.454726	0.0112	50.85269	16849.76012];
% simulation
tic;
[nLL, Chi2, BIC, AIC, rtmat, choicemat] = WW06FitBhvr5Params_QMLE_GPU(params,dataDynmc, dataBhvr);
