...
addpath('./SvrCode/');
out_dir = './Rslts/FitBhvr7ParamsII_QMLE_SvrGPU';
...
% likelihood function
% parpool(6);
nLLfun = @(params) LcDFitBhvr7ParamsII_QMLE_GPU(params, dataDynmc, dataBhvr);
[fvalbest,~,~] = nLLfun(x0)
...
% dataDynmc = load('./Data/Data.mat');
% dataBhvr = LoadRoitmanData('../../RoitmanDataCode');
% randseed = 30221312;%109340324;
% rng(randseed);
% % a, b, noise, scale, tauR,G,I
% %params = [21.369509	1.082589	24.404719	2520.316368	0.001617	0.346548	0.273613];
% params = [2.140056	1.120923	31.40612	4009.819551	0.12607	0.200605	0.439553];
% w = ones(2);
% a = eye(2)*params(1); %params(3);
% b = eye(2)*params(2);
% sgm = params(3);%params(4);
% Tau = params(5:7); %[.1,.1,.1];
