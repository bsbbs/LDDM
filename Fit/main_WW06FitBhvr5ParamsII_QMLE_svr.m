...
addpath('./SvrCode/');
out_dir = './Rslts/WW06FitBhvr5ParamsII_QMLE_GPU';
...
% likelihood function
% parpool(6);
nLLfun = @(params) WW06FitBhvr5ParamsII_QMLE_GPU(params, dataDynmc, dataBhvr);
[fvalbest,~,~] = nLLfun(x0)
...
rng(randseed);
%    JNp, JNn, I0, noise, miu0
params = [0.009311	0.604108	0.872858	0.066811	104.676946	16951.658441];
% simulation
tic;
[nLL, Chi2, BIC, AIC, rtmat, choicemat] = WW06FitBhvr5ParamsII_QMLE_GPU(params,dataDynmc, dataBhvr);
