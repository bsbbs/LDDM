...
addpath('./SvrCode/');
out_dir = './Rslts/FitBhvr4ParamsIV_QMLE_SvrGPU';
...
% likelihood function
% parpool(6);
nLLfun = @(params) LcDFitBhvr4ParamsIV_QMLE_GPU(params, dataDynmc, dataBhvr);
[fvalbest,~,~] = nLLfun(x0)
...
rng(randseed);
% a, b, noise, scale, nLL
params = [0.012185	1.250956	34.575588	1607.00612	17118.262175];
% simulation
tic;
[nLL, Chi2, BIC, AIC, rtmat, choicemat, argmaxR, sm_mr1c, sm_mr2c, sm_mr1cD, sm_mr2cD] = LcDFitBhvr4ParamsIV_QMLE_GPU(params, dataDynmc, dataBhvr);
name = sprintf('a%2.1f_b%1.1f_niose%2.1f_scl%2.1f_nLL%4.1f',params);
save(fullfile(plot_dir,sprintf('PlotData_%s.mat',name)),...
    'rtmat','choicemat','sm_mr1c','sm_mr2c','sm_mr1cD','sm_mr2cD','params','nLL','Chi2','AIC','BIC');
toc
...
xticks(0:.2:.8);
set(gca,'FontSize',16);
legend(lg,{'0','3.2','6.4','12.8','25.6','51.2'},'Location','best','FontSize',11);
