...
% likelihood function
% parpool(6);
nLLfun = @(params) LcDFitBhvr4ParamsII_QMLE_GPU(params, dataDynmc, dataBhvr);
[fvalbest,~,~] = nLLfun(x0)
...
randseed = 14610483; %22967888;
rng(randseed);
% a, b, noise, scale
params = [0.037882	1.340752	30.813328	1343.080397	16943.21813];
% simulation
tic;
[nLL, Chi2, BIC, AIC, rtmat, choicemat, argmaxR, sm_mr1c, sm_mr2c, sm_mr1cD, sm_mr2cD] = LcDFitBhvr4ParamsII_QMLE_GPU(params, dataDynmc, dataBhvr);
