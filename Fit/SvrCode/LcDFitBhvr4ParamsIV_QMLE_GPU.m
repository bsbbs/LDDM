function [nLL, Chi2, BIC, AIC, rtmat, choicemat, argmaxR, sm_mr1c, sm_mr2c, sm_mr1cD, sm_mr2cD] = LcDFitBhvr4ParamsIV_QMLE_GPU(params,dataDynmc, dataBhvr)
...
tgap = 0; % the time period in the beginning of dynamc that having no inputs
scale = params(4);
...
stoprule = 1;
w = [1 1; 1 1];
Rstar = 32; % ~ 32 Hz at the bottom of initia dip, according to Roitman and Shadlen's data
...
for vi = 1:6
    ...
    f(:,:,vi) = log(10^-16*OP(:,:,vi)+(EN(:,:,vi)/En(vi)));
